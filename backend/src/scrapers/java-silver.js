...
// Java Silver スクレイパー
// Oracle認定Java資格はPearson VUEで随時受験
class JavaSilverScraper extends BaseScraper {
  async fetch() {
    try {
      ...
      result.note = 'Java SE 11 Silver（1Z0-815）はPearson VUEで受験できます。試験時間：180分、問題数：80問、合格基準：63%。Pearson VUE公式サイトで受験料を確認してください。';
...
module.exports = JavaSilverScraper;
